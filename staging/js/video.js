...
var startWatchVideoProgress = function () {
  ...
  smartplayer.instances.forEach(function (instance) {
    ...
    instance.on("timeupdate", () => {
      ...
      if (
        instance.analytics.player.options.id == "659e8dd561c0ba0009beeba2_0" // Desktop video ID
      ) {
        SECONDS_TO_DISPLAY = 2230;
      } else if (
        instance.analytics.player.options.id == "65a013cf0922ed00090f3027_0" // Mobile video ID
      ) {
        SECONDS_TO_DISPLAY = 2230;
      }
  ...
  function checkVisibility() {
    ...
    if (
      isPageVisible &&
      isVideoVisible &&
      (isVideoPlayed || (videoElement && videoElement.autoplay)) &&
      currentInstance &&
      !currentInstance.video.paused
    ) {
      // Maximize video
      maximizeVideo();
    } else if (
  ...
  function maximizeVideo() {
    ...
    let BlueHead = document.querySelector("#important");
    let NewTitle = document.querySelector("#subHide");
