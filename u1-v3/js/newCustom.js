var upsell1notification = {
  1: {
           ...
           imageshfl:"url('https://lungreset.com/u1-v3/assets/9-Bottles-Of-Breathe-With-Bonuses-1.png')"
         },
       2: {
           time:"53 min. ago",
       ...
       6: {
           ...
           imageshfl:"url('https://lungreset.com/u1-v3/assets/6-Bottles-Of-Breathe-With-Bonuses-1.png')"
       },
       7: {
           time:"33 min. ago",
       ...
       16: {
           ...
           imageshfl:"url('https://lungreset.com/u1-v3/assets/3-Bottles-Of-Breathe-With-Bonuses-1.png')"
       },
       17: {
           time:"19 min. ago",
...
var startWatchVideoProgress = function () {
  ...
  smartplayer.instances.forEach(function (instance) {
    ...
    instance.on("timeupdate", () => {
      ...
      if (
        instance.analytics.player.options.id == "671b55f3fbcadf000bf9d12b" // Desktop video ID
      ) {
        SECONDS_TO_DISPLAY = 373;
      } else if (
        instance.analytics.player.options.id == "671b55f3fbcadf000bf9d12b" // Mobile video ID
      ) {
        SECONDS_TO_DISPLAY = 373;
      }
