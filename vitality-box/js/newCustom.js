...
var checkVisit = localStorage.getItem("sectionShownUpsell1");
    ...
    instance.on("timeupdate", () => {
      ...
      if (
        ...
        if (checkVisit == null) {
          ...
          localStorage.setItem("sectionShownUpsell1", true);
          contentsDisplayed = true;
          checkVisit = localStorage.getItem("sectionShownUpsell1");
