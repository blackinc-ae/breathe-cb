var upsell1notification = {
  1: {
           ...
           imageshfl:"url('https://lungreset.com/u1-v4/assets/9-Bottles-Of-Breathe-With-Bonuses-1.png')"
         },
       2: {
           time:"53 min. ago",
       ...
       6: {
           ...
           imageshfl:"url('https://lungreset.com/u1-v4/assets/6-Bottles-Of-Breathe-With-Bonuses-1.png')"
       },
       7: {
           time:"33 min. ago",
       ...
       16: {
           ...
           imageshfl:"url('https://lungreset.com/u1-v4/assets/3-Bottles-Of-Breathe-With-Bonuses-1.png')"
       },
       17: {
           time:"19 min. ago",
...
///////
  ...
  function upsell1ShowNotification(key) {
      ...
      $('.shuffle_image').css('background-image',upsell1notification[key].imageshfl);
      $('.shuffle_div').fadeIn();
      setTimeout(function() {
          $('.shuffle_div').fadeOut();
      }, 5000);
...
var startWatchVideoProgress = function () {
  ...
  smartplayer.instances.forEach(function (instance) {
    ...
    instance.on("timeupdate", () => {
      ...
      if (
        instance.analytics.player.options.id == "671b7a297de824000c64889b" // Desktop video ID
      ) {
        SECONDS_TO_DISPLAY = 376;
      } else if (
        instance.analytics.player.options.id == "671b7a297de824000c64889b" // Mobile video ID
      ) {
        SECONDS_TO_DISPLAY = 376;
      }
