...
var startWatchVideoProgress = function () {
  ...
  smartplayer.instances.forEach(function (instance) {
    ...
    instance.on("timeupdate", () => {
      ...
      if (
        instance.analytics.player.options.id == "665df443aeb13f000b9880d7_0" // Desktop video ID
      ) {
        SECONDS_TO_DISPLAY = 794;
      } else if (
        instance.analytics.player.options.id == "665df4ecdb56b8000bc1424c_0" // Mobile video ID
      ) {
        SECONDS_TO_DISPLAY = 794;
      }
