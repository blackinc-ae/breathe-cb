...
var startWatchVideoProgress = function () {
  ...
  smartplayer.instances.forEach(function (instance) {
    ...
    instance.on("timeupdate", () => {
      ...
      if (
        instance.analytics.player.options.id == "665df305c28e81000bdf2170_0" // Desktop video ID
      ) {
        SECONDS_TO_DISPLAY = 788;
      } else if (
        instance.analytics.player.options.id == "665df39ee2cf5d000b2f51be_0" // Mobile video ID
      ) {
        SECONDS_TO_DISPLAY = 788;
      }
