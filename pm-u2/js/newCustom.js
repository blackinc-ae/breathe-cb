...
document.querySelector(".showItem").style.display = "none";
var checkVisit = localStorage.getItem("sectionShownUpsell2");
  ...
  smartplayer.instances.forEach(function (instance) {
    ...
    instance.on("timeupdate", () => {
      ...
      if (
        ...
        instance.analytics.player.options.id == "66b09368c4258b000b1b010f" // Mobile video ID
      ) {
        SECONDS_TO_DISPLAY = 420;
      }
      ...
      if (
        ...
        if (checkVisit == null) {
          ...
          localStorage.setItem("sectionShownUpsell2", true);
          contentsDisplayed = true;
          checkVisit = localStorage.getItem("sectionShownUpsell2");
          document.querySelector(".showItem").style.display =
            "block";
          var targetElement;
...
if (checkVisit === "true") {
  document.querySelector(".showItem").style.display = "block";
  document.getElementById("shuffle").style.display = "block";
  setTimeout(function () {
    console.log("Watched Video");
    upsell1DisplayNotifications();
