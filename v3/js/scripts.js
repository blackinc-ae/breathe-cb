  ...
  var startWatchVideoProgress = function () {
    ...
    smartplayer.instances.forEach(function (instance) {
      ...
      instance.on("timeupdate", () => {
        ...
        if (
          instance.analytics.player.options.id == "670fabe2b52138000bc270ee" // Desktop video ID
        ) {
          SECONDS_TO_DISPLAY = 2599;
        } else if (
          instance.analytics.player.options.id == "670fabe2b52138000bc270ee" // Mobile video ID
        ) {
          SECONDS_TO_DISPLAY = 2599;
        }
