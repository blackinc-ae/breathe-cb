  ...
  var startWatchVideoProgress = function () {
    ...
    smartplayer.instances.forEach(function (instance) {
      ...
      instance.on("timeupdate", () => {
        ...
        if (
          instance.analytics.player.options.id == "66951de6979685000b5abffa" // Desktop video ID
        ) {
          SECONDS_TO_DISPLAY = 2327;
        } else if (
          instance.analytics.player.options.id == "669ea6abe1b108000b3716d8" // Mobile video ID
        ) {
          SECONDS_TO_DISPLAY = 2327;
        }
