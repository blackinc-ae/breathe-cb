...
var startWatchVideoProgress = function () {
  ...
  smartplayer.instances.forEach(function (instance) {
    ...
    instance.on("timeupdate", () => {
      ...
      if (
        instance.analytics.player.options.id == "662f508b206b9c000c942d68" // Desktop video ID
      ) {
        SECONDS_TO_DISPLAY = 798;
      } else if (
        instance.analytics.player.options.id == "6634e1c82cd33f000b0ee858" // Mobile video ID
      ) {
        SECONDS_TO_DISPLAY = 798;
      }
